...
// 		assert twt != null : "twt cannot be null";
// 		this.rawRetweet = twt.rawRetweet;
// 		this.retweet = twt.retweet;
// 		this.text = twt.text;
// 		this.tweetScore = twt.tweetScore;
// 	    for (Word w : twt.words()) {
// 	    	Word word = Word.valueOf(w.toString(),this);
// 	    	words.add(word);
// 	    	tf.put(w.toString(), twt.tf().get(w.toString()));
// 	    	//df.put(word, tf.getOrDefault(word,new ArrayList<>()).add(this));
// 	    }
// 	    this.tweetScore = retweet;
// 	}
